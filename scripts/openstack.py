...
""")
    ...
    parser.add_argument(
        ...
        default='ubuntu@teuthology-logs.public.zbkc.com:./',
    )
    parser.add_argument(
        '--archive-upload-url',
        help='Public facing URL where archives are uploaded',
        default='http://teuthology-logs.public.zbkc.com',
    )
    ...
    parser.add_argument(
        '-c', '--zbkc',
        help='The zbkc branch to run against',
        default='master',
    )
    parser.add_argument(
        '-k', '--kernel',
    ...
    parser.add_argument(
        '--suite-branch',
        help='Use this suite branch instead of the zbkc branch',
    )
    parser.add_argument(
        '-e', '--email',
    ...
    parser.add_argument(
        '--zbkc-git-url',
        help=("git clone url for Zbkc"),
    )
    parser.add_argument(
        '--zbkc-qa-suite-git-url',
        help=("git clone url for zbkc-qa-suite"),
    )
