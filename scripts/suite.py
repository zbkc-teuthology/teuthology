...
usage: teuthology-suite --help
       teuthology-suite [-v | -vv ] --zbkc <zbkc> --suite <suite> [options] [<config_yaml>...]
       teuthology-suite [-v | -vv ] --zbkc <zbkc> --rerun <name>  [options] [<config_yaml>...]

Run a suite of zbkc integration tests. A suite is a directory containing
...
Standard arguments:
  ...
  -c <zbkc>, --zbkc <zbkc>    The zbkc branch to run against
  -S <sha1>, --sha1 <sha1>    The zbkc sha1 to run against (overrides -c)
  ...
  -n <newest>, --newest <newest>
                              ...
                              either --zbkc or --sha1, backtracking
  ...
  --zbkc-repo <zbkc_repo>     Query this repository for Zbkc branch and SHA1
                              values [default: {default_zbkc_repo}]
  ...
  --suite-branch <suite_branch>
                              Use this suite branch instead of the zbkc branch
...
""".format(
    ...
    default_zbkc_repo=config.get_zbkc_git_url(),
    default_suite_repo=config.get_zbkc_qa_suite_git_url(),
)
