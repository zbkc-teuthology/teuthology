...
Here is a sample configuration with many of the options set and documented::
    ...
    results_email: zbkc-qa@example.com
    ...
    # Gitbuilder archive that stores e.g. zbkc packages
    gitbuilder_host: gitbuilder.example.com

    # URL for 'gitserver' helper web application
    # see http://github.com/zbkc/gitserver
    githelper_base_url: http://git.zbkc.com:8080

    # Verify the packages signatures
    check_package_signatures: true

    # Where all git repos are considered to reside.
    zbkc_git_base_url: https://github.com/zbkc/

    # Where the zbkc git repo is considered to reside.
    zbkc_git_url: https://github.com/zbkc/zbkc.git

    # Where the zbkc-qa-suite git repo is considered to reside.
    zbkc_qa_suite_git_url: https://github.com/zbkc/zbkc-qa-suite.git

    # Where teuthology and zbkc-qa-suite repos should be stored locally
    ...
    # {proj} is the value of 'project' from the job yaml file or 'zbkc'
    ...
    # desired zbkc branch exists in the gitbuilder. If False, no
    ...
    #
    archive_upload: ubuntu@teuthology-logs.public.zbkc.com:./
    ...
    #
    archive_upload_url: http://teuthology-logs.public.zbkc.com/
    ...
    openstack:
      ...
      #
      clone: git clone http://github.com/zbkc/teuthology
