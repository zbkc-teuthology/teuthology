...
class TestResultsEmail(object):
    reference = {
        ...
        'jobs': [
            ...
            {'description': 'description for job with name test_name',
             'job_id': 30481,
             'name': 'test_name',
             'log_href': 'http://qa-proxy.zbkc.com/teuthology/test_name/30481/teuthology.log',  # noqa
             'owner': 'job@owner',
             'duration': None,
             'status': 'running',
             },
            ...
            {'description': 'description for job with name test_name',
             'job_id': 88979,
             'name': 'test_name',
             'log_href': 'http://qa-proxy.zbkc.com/teuthology/test_name/88979/teuthology.log',  # noqa
             'owner': 'job@owner',
             'duration': 35190,
             'success': False,
             'status': 'fail',
            ...
            {'description': 'description for job with name test_name',
             'job_id': 69152,
             'name': 'test_name',
             'log_href': 'http://qa-proxy.zbkc.com/teuthology/test_name/69152/teuthology.log',  # noqa
             'owner': 'job@owner',
             'duration': 5225,
             'success': False,
             'status': 'dead',
            ...
            {'description': 'description for job with name test_name',
             'job_id': 68369,
             'name': 'test_name',
             'log_href': 'http://qa-proxy.zbkc.com/teuthology/test_name/68369/teuthology.log',  # noqa
             'owner': 'job@owner',
             'duration': 33771,
             'success': True,
             'status': 'pass',
    ...
    logs:    http://qa-proxy.zbkc.com/teuthology/test_name/
    failed:  1
    dead:    1
    running: 1
    waiting: 1
    ...
    log:    http://qa-proxy.zbkc.com/teuthology/test_name/88979/
    ...
    log:    http://qa-proxy.zbkc.com/teuthology/test_name/69152/
    ...
    def setup(self):
        ...
        config.archive_server = "http://qa-proxy.zbkc.com/teuthology/"
