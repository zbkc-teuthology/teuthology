...
class TestRepoUtils(object):
    ...
    # online_repo_url = 'https://github.com/zbkc/teuthology.git'
    # online_repo_url = 'git://zbkc.hanhaixingyun.com/git/teuthology.git'
    online_repo_url = 'https://github.com/zbkc/empty.git'
    ...
    def setup_method(self, method):
        ...
        assert proc.wait() == 0
        proc = subprocess.Popen(
            ('git', 'config', 'user.email', 'test@zbkc.com'),
            cwd=self.src_path,
            stdout=subprocess.PIPE,
        )
        assert proc.wait() == 0
