...
class TestTeuthologyConfig(TestYamlConfig):
    ...
    def test_get_zbkc_git_base_default(self):
        conf_obj = self.test_class()
        conf_obj.yaml_path = ''
        conf_obj.load()
        assert conf_obj.zbkc_git_base_url == "https://github.com/zbkc/"

    def test_set_zbkc_git_base_via_private(self):
        conf_obj = self.test_class()
        conf_obj._conf['zbkc_git_base_url'] = \
            "git://git.zbkc.com/"
        assert conf_obj.zbkc_git_base_url == "git://git.zbkc.com/"
