...
class DaemonGroup(object):
    ...
    def get_daemon(self, type_, id_, cluster='zbkc'):
        """
    ...
    def iter_daemons_of_role(self, type_, cluster='zbkc'):
        """
