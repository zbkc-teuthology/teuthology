...
class TeuthologyConfig(YamlConfig):
    ...
    _defaults = {
        ...
        'zbkc_git_url': None,
        'zbkc_qa_suite_git_url': None,
        'use_conserver': False,
        'conserver_master': 'conserver.front.sepia.zbkc.com',
        'conserver_port': 3109,
        'gitbuilder_host': 'gitbuilder.zbkc.com',
        'githelper_base_url': 'http://git.zbkc.com:8080',
        'check_package_signatures': True,
        'lab_domain': 'front.sepia.zbkc.com',
        'lock_server': 'http://paddles.front.sepia.zbkc.com/',
        'max_job_time': 259200,  # 3 days
        'nsupdate_url': 'http://nsupdate.front.sepia.zbkc.com/update',
        'results_server': 'http://paddles.front.sepia.zbkc.com/',
        'results_ui_server': 'http://pulpito.zbkc.com/',
    ...
    def get_zbkc_qa_suite_git_url(self):
        return (self.zbkc_qa_suite_git_url or
                self.get_zbkc_git_url())

    def get_zbkc_git_url(self):
        return (self.zbkc_git_url or
                self.zbkc_git_base_url + 'zbkc-ci.git')
